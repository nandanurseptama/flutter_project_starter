...
class CommentsBloc extends Bloc<CommentsEvent, CommentsState> {
  ...
  CommentsBloc({required GetSingleCommentUsecase getSingleCommentUsecase})
      : _getSingleCommentUsecase = getSingleCommentUsecase,
        super(CommentsState.loading()) {
    on<CommentsEvent>((event, emit) {
      return event.maybeMap<void>(loadSingleComment: (loadSingleCommentEvent) {
  ...
  void _loadSingleCommentEventListener(
      int id, Emitter<CommentsState> emit) async {
